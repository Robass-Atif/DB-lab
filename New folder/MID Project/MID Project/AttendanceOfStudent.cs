...
namespace MID_Project
{
    public partial class AttendanceOfStudent : Form
    {
        ...
        private void loadStudent()
        {
            ...
            cmd.Parameters.AddWithValue("@AttendanceDate", dateTimePicker2.Value.ToString("yyyy-MM-dd HH:mm:ss"));
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
            int attendanceId = Convert.ToInt32(dt.Rows[0][0]);
            ...
            da1.Fill(dt1);
            int statusId = Convert.ToInt32(dt1.Rows[0][0]);
            ...
            da2.Fill(dt2);
            int studentId = Convert.ToInt32(dt2.Rows[0][0]);
